...
class TestInitIntegrationFlag:
    def test_integration_and_ai_mutually_exclusive(self, tmp_path):
        ...
        assert "互斥" in result.output or "mutually exclusive" in result.output
    ...
    def test_unknown_integration_rejected(self, tmp_path):
        ...
        assert result.exit_code != 0
        assert "Unknown integration" in result.output or "未知的集成" in result.output or "未知集成" in result.output

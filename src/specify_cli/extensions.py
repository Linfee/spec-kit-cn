...
class ExtensionCatalog:
    ...
    DEFAULT_CATALOG_URL = "https://raw.githubusercontent.com/Linfee/spec-kit-cn/main/extensions/catalog.json"
    COMMUNITY_CATALOG_URL = "https://raw.githubusercontent.com/Linfee/spec-kit-cn/main/extensions/catalog.community.json"
    ...
    def _get_merged_extensions(self, force_refresh: bool = False) -> List[Dict[str, Any]]:
        ...
        for catalog_entry in active_catalogs:
            try:
                ...
                print(
                    f"警告: 无法获取目录 '{catalog_entry.name}': {e}",
                    file=sys.stderr,
                )
                continue

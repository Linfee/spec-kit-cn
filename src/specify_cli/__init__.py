...
AGENT_CONFIG = {
    ...
    "qoder": {
        "name": "Qoder CLI",
        "folder": ".qoder/",
        "install_url": "https://github.com/qoder-cli/qoder",
        "requires_cli": True,
    },
    "roo": {
        "name": "Roo Code",
...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor-agent, qwen, opencode, codex, windsurf, kilocode, auggie, codebuddy, qoder, roo, amp, shai, q, bob, or jules"),
